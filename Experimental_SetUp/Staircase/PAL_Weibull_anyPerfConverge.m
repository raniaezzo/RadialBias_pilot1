...
function y = PAL_Weibull_anyPerfConverge(params,x,varargin)

% get expected performance convergence level
performance = usePalamedesStaircase('getPerformanceLevel');
...
base = 1/(1-((performance-gamma)/(1-gamma-lambda)));
