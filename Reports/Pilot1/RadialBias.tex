...
\begin{figure}[H]
\centering % centers the figure
\includegraphics[scale=.35]{Images/RE_PP_sensitivity_Alldata_4conds.png}
\includegraphics[scale=.35]{Images/RE_PP_sensitivity_Alldata_2conds.png}
\end{figure}
\begin{figure}[H]
\centering % centers the figure
\includegraphics[scale=.35]{Images/FH_PP_sensitivity_Alldata_4conds.png}
\includegraphics[scale=.35]{Images/FH_PP_sensitivity_Alldata_2conds.png}
\end{figure}
\begin{figure}[H]
\centering % centers the figure
\includegraphics[scale=.35]{Images/BB_PP_sensitivity_Alldata_4conds.png}
\includegraphics[scale=.35]{Images/BB_PP_sensitivity_Alldata_2conds.png}
\caption{LEFT: 200 trials per point. RIGHT: Each point is 400 trials. 95\% CI plotted from 1,000 bootstraps.}
\end{figure}
...
\begin{figure}[H]
\centering % centers the figure
\includegraphics[scale=.35]{Images/RE_LP_sensitivity_Alldata_4conds.png}
\includegraphics[scale=.35]{Images/RE_LP_sensitivity_Alldata_2conds.png}
\end{figure}
\begin{figure}[H]
\centering % centers the figure
\includegraphics[scale=.35]{Images/FH_LP_sensitivity_Alldata_4conds.png}
\includegraphics[scale=.35]{Images/FH_LP_sensitivity_Alldata_2conds.png}
\end{figure}
\begin{figure}[H]
\centering % centers the figure
\includegraphics[scale=.35]{Images/BB_LP_sensitivity_Alldata_4conds.png}
\includegraphics[scale=.35]{Images/BB_LP_sensitivity_Alldata_2conds.png}
\caption{LEFT: 200 trials per point. RIGHT: Each point is 400 trials. Green CIs are 68\% confidence. Black CIs are 95\% confidence.}
\end{figure}
...
\begin{figure}[H]
\centering % centers the figure
\includegraphics[scale=.35]{Images/RE_PP_bias_Alldata_4conds.png}
\includegraphics[scale=.35]{Images/RE_PP_bias_Alldata_2conds.png}
\end{figure}
\begin{figure}[H]
\centering % centers the figure
\includegraphics[scale=.35]{Images/FH_PP_bias_Alldata_4conds.png}
\includegraphics[scale=.35]{Images/FH_PP_bias_Alldata_2conds.png}
\end{figure}
\begin{figure}[H]
\centering % centers the figure
\includegraphics[scale=.35]{Images/BB_PP_bias_Alldata_4conds.png}
\includegraphics[scale=.35]{Images/BB_PP_bias_Alldata_2conds.png}
\caption{LEFT: 200 trials per point. RIGHT: Points are either 200 or 400 trials. 95\% CI plotted from 1,000 bootstraps.}
\end{figure}
...
\begin{figure}[H]
\centering % centers the figure
\includegraphics[scale=.35]{Images/RE_LP_bias_Alldata_4conds.png}
\includegraphics[scale=.35]{Images/RE_LP_bias_Alldata_2conds.png}
\end{figure}
\begin{figure}[H]
\centering % centers the figure
\includegraphics[scale=.35]{Images/FH_LP_bias_Alldata_4conds.png}
\includegraphics[scale=.35]{Images/FH_LP_bias_Alldata_2conds.png}
\end{figure}
\begin{figure}[H]
\centering % centers the figure
\includegraphics[scale=.35]{Images/BB_LP_bias_Alldata_4conds.png}
\includegraphics[scale=.35]{Images/BB_LP_bias_Alldata_2conds.png}
\caption{LEFT: 200 trials per point. RIGHT: Each point is 400 trials. Green CIs are 68\% confidence. Black CIs are 95\% confidence.}
\end{figure}
...
\subsection{Goals}
\begin{enumerate}
	\item Localize MT+ using moving vs. static stimuli
	\item Map retinotopy of MT, MST, (and V1) using methods similar to Huk et al., 2002 and Amano et al., 2009
	\begin{itemize}
		\item Create polar angle maps and calculate cortical surface area dedicated to upper 45 deg wedge., lower 45 deg. wedge
		\item Extend analysis to upper vs. lower visual field since found in macaque but not yet reported for human
	\end{itemize}
	\item Calculate difference in BOLD magnitude for upper vs. lower vertical meridian
	\item Inverted encoding model (can we predict what stimulus was shown -- radial vs. tangential)
	\begin{itemize}
