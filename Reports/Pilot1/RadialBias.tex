...
\item Analysis Related
	...
	\item Added plots with each MOTION VECTOR per condition (per subject)
	\end{itemize}
...
\item For discussion
	\begin{itemize}
	\item Go over new data and individual PFs, especially for Nina?
	\item Wonder why bias is not higher for off-cardinal locations?
	\item fMRI design
	\item Plaid design
