...
\begin{figure}[H]
\centering % centers the figure
\includegraphics[scale=.3]{Images/ME_PP_sensitivity_Alldata_4conds_relative.png}
\includegraphics[scale=.3]{Images/ME_PP_sensitivity_Alldata_2conds_relative.png}
\caption{LEFT: 20 trials per point. RIGHT: 40 trials per point. 68\% CI from 1000 bootstraps.}
\end{figure}
\begin{figure}[H]
\centering % centers the figure
\includegraphics[scale=.3]{Images/SX_PP_sensitivity_Alldata_4conds_relative.png}
\includegraphics[scale=.3]{Images/SX_PP_sensitivity_Alldata_2conds_relative.png}
\caption{LEFT: 20 trials per point. RIGHT: 40 trials per point. 68\% CI from 1000 bootstraps.}
\end{figure}
...
\includegraphics[scale=.35]{Images/NH_PP_sensitivity_Alldata_1conds_dataset1_vs2.png}
...
\includegraphics[scale=.35]{Images/ME_switch_PP_sensitivity_Alldata_2conds_relative_card_vsoblique.png}
\includegraphics[scale=.35]{Images/SX_switch_PP_sensitivity_Alldata_2conds_relative_card_vsoblique.png}
\includegraphics[scale=.17]{Images/NH_switch_PP_sensitivity_Alldata_2conds_relative_card_vsoblique.png}
...
\includegraphics[scale=.35]{Images/NH_VP_Alldata_4conds_analyzeddata_6fits_abs.png}
