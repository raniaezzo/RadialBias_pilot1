...
T_example = [struct2table(subjdata.params_upwards); struct2table(subjdata.params_downwards); ...
    ...
    struct2table(subjdata.params_lowerrightwards);struct2table(subjdata.params_lowerleftwards); ...
    struct2table(subjdata.params_upperrightwards); struct2table(subjdata.params_upperleftwards)];
T_example.Properties.RowNames = {'upwards'; 'downwards';'leftwards'; 'rightwards'; 'lowerrightwards'; ...
    'lowerleftwards'; 'upperrightwards'; 'upperleftwards'};
...
cartesian_directionlabels = {'rightwards','upwards','leftwards','downwards', 'lowerrightwards', ...
    'lowerleftwards', 'upperrightwards', 'upperleftwards'};
...
T_example = [struct2table(subjdata.params_upperleftwards); struct2table(subjdata.params_upperrightwards); ...
    ...
    struct2table(subjdata.params_rightwards); struct2table(subjdata.params_leftwards); ...
    struct2table(subjdata.params_upwards); struct2table(subjdata.params_downwards)];
...
oblique_locationdegrees = {315,135,225,45, 0, 90, 180, 270};
