function average_locations2(relative_summarypath)
    ...
    radialconds = {params_radial};
    tangconds = {params_tang};
    bootradialconds = {bootparams_radial};
    boottangconds = {bootparams_tang};
